...
class DesignCaseSpider(scrapy.Spider):
    ...
    cookie = {'_ga':'GA1.2.717037102.1543486394', '__qca':'P0-562709909-1543486394722', '_gid':'GA1.2.1530687562.1544178201'}
    ...
    def parse_detail(self, response):
        ...
        try:
            ...
            img_url = response.xpath('//img[@class="postpic"]/@src').extract()[0]
        if not img_url.startswith('http://www.yankodesign.com'):
            img_url = 'http://www.yankodesign.com' + img_url
